...
main(int argc, char *argv[])
{
  ...
  42:	c7 44 24 04 5a 07 00 	movl   $0x75a,0x4(%esp)
  49:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37a:	f7 f7                	div    %edi
 37c:	0f b6 92 7a 07 00 00 	movzbl 0x77a(%edx),%edx
...
putc(int fd, char c)
{
 ...
 510:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 513:	b9 73 07 00 00       	mov    $0x773,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5d1:	a1 94 07 00 00       	mov    0x794,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 61f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 621:	a3 94 07 00 00       	mov    %eax,0x794
}
 626:	5b                   	pop    %ebx
 627:	5e                   	pop    %esi
 628:	5f                   	pop    %edi
 ...
 64b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 94 07 00 00       	mov    %eax,0x794
}
 652:	5b                   	pop    %ebx
 653:	5e                   	pop    %esi
 654:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 669:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 66c:	8b 0d 94 07 00 00    	mov    0x794,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 69c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6a0:	3b 05 94 07 00 00    	cmp    0x794,%eax
 ...
 6bf:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6c2:	89 0d 94 07 00 00    	mov    %ecx,0x794
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 702:	e8 c9 fe ff ff       	call   5d0 <free>
  return freep;
 707:	8b 0d 94 07 00 00    	mov    0x794,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	eb a4                	jmp    6c2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 71e:	c7 05 94 07 00 00 8c 	movl   $0x78c,0x794
 725:	07 00 00 
    base.s.size = 0;
 728:	b9 8c 07 00 00       	mov    $0x78c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72d:	c7 05 8c 07 00 00 8c 	movl   $0x78c,0x78c
 734:	07 00 00 
    base.s.size = 0;
 737:	c7 05 90 07 00 00 00 	movl   $0x0,0x790
 73e:	00 00 00 
